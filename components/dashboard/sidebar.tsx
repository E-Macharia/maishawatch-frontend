    ...
    <>
      ...
      <aside
        className={cn(
          ...
          isMobileOpen ? "w-[248px] translate-x-0" : "-translate-x-full lg:translate-x-0"
        )}
      >
        {/* Brand Header */}
          ...
          <Link href="/overview" onClick={closeMobileSidebar} className="flex min-w-0 items-center gap-3">
            ...
            {!isCollapsed && (
              <div className="min-w-0">
                <p className="truncate text-sm font-bold tracking-tight text-sidebar-foreground">MaishaWatch</p>
                    ...
                    >
                      ...
                      <Icon
                        className={cn(
                          ...
                          isActive ? "text-primary font-bold" : "text-muted-foreground group-hover:text-sidebar-foreground"
                        )}
                      />
          ...
          {!isCollapsed ? (
            <div className="rounded-xl border border-sidebar-border bg-sidebar-accent/40 p-3.5 shadow-xs">
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs font-bold text-sidebar-foreground">Monitoring Active</span>
              </div>
